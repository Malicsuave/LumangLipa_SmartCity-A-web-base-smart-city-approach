...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("UPDATE pre_registrations SET educational_attainment = 'No Formal Education' WHERE educational_attainment NOT IN ('No Formal Education','Elementary Undergraduate','Elementary Graduate','High School Undergraduate','High School Graduate','Vocational/Technical Graduate','College Undergraduate','College Graduate','Post Graduate') AND educational_attainment IS NOT NULL");
