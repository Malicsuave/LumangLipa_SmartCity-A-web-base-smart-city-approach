...
<head>
    ...
    <title>Certificate of Relationship - {{ $fullName }}</title>
    @php
                                ...
                                <td colspan="2" style="padding-top:0; vertical-align: top;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            This further certifies that the above-named individual is the
                                            <span class="cert-fill">{{ strtoupper($documentRequest->relationship_type ?? 'N/A') }}</span>
                                            of
                                            <span class="cert-fill">{{ strtoupper($documentRequest->related_person_name ?? 'N/A') }}</span>.
                                        </div>
                                        <div style="text-indent: 40px; margin-top: 18px;">
                            ...
                            <tr>
                                <td colspan="2" style="padding:0; vertical-align:bottom;">
                                    <table style="width:100%; border-collapse:collapse;">
                                        <tr>
                                            <td colspan="2" style="text-align:left; padding-top:20px; padding-bottom:100px;">
                                                <div style="border-bottom:1px solid #000; width:280px; margin-bottom:5px;"></div>
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align:center; padding-bottom:100px; padding-top:50px;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 20px 10px 20px 0;">
