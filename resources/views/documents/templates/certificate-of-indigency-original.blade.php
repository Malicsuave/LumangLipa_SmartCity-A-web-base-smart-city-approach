...
<head>
    ...
    <title>Certificate of Indigency - {{ $fullName }}</title>
    @php
    ...
    <style>
        ...
        * {
        ...
        .certificate-body {
            font-size: 16px;
            /* I've changed this to 1.6 to match your Clearance file. 
               This helps prevent the page from overflowing.
            */
            line-height: 1.6;
            text-align: left;
            margin: 15px 0 0 0;
                                ...
                                <td colspan="2" style="padding-top:0; vertical-align: top;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <div style="text-indent: 40px;">
                                            ...
                                            of Barangay Lumanglipa, Mataas na Kahoy, Batangas, belongs to indigent family. The said person is seeking
                                            <span class="cert-fill">{{ strtoupper($purpose ?? '') }}</span>
                            ...
                            <tr>
                                <td colspan="2" style="padding:0; vertical-align:bottom;">
                                    <table style="width:100%; border-collapse:collapse;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 100px 10px 20px 15px;">
