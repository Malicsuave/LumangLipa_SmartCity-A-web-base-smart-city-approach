...
<div class="w-full md:w-64 bg-white md:border-r border-gray-200 md:min-h-screen">
    ...
    <nav class="mt-5 px-2">
        ...
        <a href="{{ route('admin.health') }}" class="mt-1 group flex items-center px-4 py-2 text-base leading-6 font-medium rounded-md {{ request()->routeIs('admin.health') ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150">
            <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.health') ? 'text-gray-500' : 'text-gray-400 group-hover:text-gray-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('admin.complaints') }}" class="mt-1 group flex items-center px-4 py-2 text-base leading-6 font-medium rounded-md {{ request()->routeIs('admin.complaints') ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} focus:outline-none focus:bg-gray-200 transition ease-in-out duration-150">
            <svg class="mr-3 h-6 w-6 {{ request()->routeIs('admin.complaints') ? 'text-gray-500' : 'text-gray-400 group-hover:text-gray-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
