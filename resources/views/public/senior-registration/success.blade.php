...
<script>
  ...
  if (typeof(Storage) !== "undefined") {
    sessionStorage.removeItem('senior_registration_step1');
    sessionStorage.removeItem('senior_registration_step2');
    sessionStorage.removeItem('senior_registration_step3');
    sessionStorage.removeItem('senior_registration_step4');
  }
</script>
@endpush
