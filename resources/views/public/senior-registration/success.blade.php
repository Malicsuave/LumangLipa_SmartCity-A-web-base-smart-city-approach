...
@section('title', 'Senior Citizen Pre-Registration - Success')

@section('form-title', 'Senior Citizen Pre-Registration')
@section('step-indicator', 'Completed')
...
<div class="card-body text-center py-5">
  ...
  <p class="lead mb-4">Thank you for submitting your senior citizen pre-registration.</p>
