...
@section('title', 'Resident Pre-Registration')
        ...
        <div class="col-lg-8">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-primary text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="material-icons me-2">person</i> Resident Pre-Registration</h4>
                    <span class="badge bg-light text-primary">Step 1 of 5</span>
                </div>
                <form action="{{ route('public.resident-pre-registration.store') }}" method="POST" id="residentPreRegForm">
                    @csrf
                    <div class="card-body">
                        <!-- Type of Resident -->
                        <div class="mb-4">
