...
$(document).ready(function() {
    // Initialize DataTable with same configuration as Pre-Registration
    ...
    // Add export buttons
    new $.fn.dataTable.Buttons('#blotterComplaintsTable', {
        buttons: [
            {
                extend: 'copy',
                text: 'Copy',
...
function acceptComplaint(complaintId) {
    if (!confirm('Are you sure you want to accept this blotter/complaint? This will notify the complainant via email.')) {
        return;
    }
...
function confirmRejectComplaint() {
    ...
    if (!confirm('Are you sure you want to reject this blotter/complaint? The complainant will be notified via email.')) {
        return;
    }
