...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&family=Open+San            <div class="id-card-front-bg">
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_pat        <div class="footer-note">
        ...
        </div>mages/logo.png'))) }}" alt="Barangay Logo">
            </div>
            <div class="id-card-header">
                ...
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/citylogo.png'))) }}" alt="City Logo" class="barangay-logo-right">500;600;700&display=swap" rel="stylesheet">
    <style>
...
<body>
                    ...
                    <div class="col-md-8">
                        <div class="id-card-details">
                            ...
                            <div class="mb-2">
                                ...
                                <span>{{ $seniorCitizen->current_address }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                            ...
                            @if($seniorCitizen->photo)
                                <img src="{{ storage_path('app/public/' . $seniorCitizen->photo) }}" alt="{{ $seniorCitizen->full_name }}">
                            @else
                                <div class="no-photo">
                    ...
                    <div class="col-5">
                        ...
                        <div class="id-signature mt-2 text-center">
                            @if($seniorCitizen->signature)
                                <img src="{{ $seniorCitizen->signature }}" alt="Signature">
                            @else
    ...
    <div class="document-footer">
        ...
        <div class="footer-info">
            ...
            <span>Reference: {{ $seniorCitizen->senior_id_number }}</span>
        </div>
        <div class="footer-note">
            Official government document. Handle with care and report if lost or stolen.
            <br>Generated: {{ now()->format('F d, Y') }} | Valid until: {{ $seniorCitizen->senior_id_expires_at ? $seniorCitizen->senior_id_expires_at->format('F d, Y') : now()->addYears(5)->format('F d, Y') }}
        </div>
    </div>
</body>
</html>