...
@section('page-title', 'Register New Resident - Step 1')
@section('page-subtitle', 'Personal Information')
    ...
    <div class="col-md-12">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col text-center">
                        <small class="text-muted">Step 2: Citizenship & Education</small>
                    </div>
                    <div class="col text-center">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.residents.create.step1.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="non_migrant" name="type_of_resident" value="Non-Migrant" 
                                           class="custom-control-input" {{ old('type_of_resident', session('registration.step1.type_of_resident')) == 'Non-Migrant' ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="non_migrant">Non-Migrant</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="migrant" name="type_of_resident" value="Migrant" 
                                           class="custom-control-input" {{ old('type_of_resident', session('registration.step1.type_of_resident')) == 'Migrant' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="transient" name="type_of_resident" value="Transient" 
                                           class="custom-control-input" {{ old('type_of_resident', session('registration.step1.type_of_resident')) == 'Transient' ? 'checked' : '' }}>
