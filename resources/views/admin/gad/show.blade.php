...
<li class="breadcrumb-item active" aria-current="page">{{ $gad->resident->full_name }}</li>
@endsection

@section('page-title', 'GAD Record Details')
@section('page-subtitle', 'Viewing Gender & Development record for ' . $gad->resident->full_name)
        ...
        <div class="card shadow mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-0"><i class="fe fe-file-text fe-16 mr-2 text-primary"></i>GAD Record Details</h4>
                        <p class="text-muted mb-0">{{ $gad->resident->full_name }} - {{ $gad->resident->barangay_id }}</p>
                    </div>
                    <div>
                        <a href="{{ route('admin.gad.edit', $gad->id) }}" class="btn btn-primary mr-2">
                            <i class="fe fe-edit fe-16 mr-2"></i>Edit Record
                        </a>
                        <a href="{{ route('admin.gad.index') }}" class="btn btn-outline-secondary">
                            <i class="fe fe-arrow-left fe-16 mr-2"></i>Back to List
                        </a>
                        <div class="dropdown d-inline">
                            <button class="btn btn-outline-dark dropdown-toggle ml-2" type="button" id="actionDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="actionDropdown">
                                <form action="{{ route('admin.gad.destroy', $gad->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this GAD record? This action cannot be undone.');">
                                    ...
                                    <button type="submit" class="dropdown-item text-danger">
                                        <i class="fe fe-trash mr-1"></i> Delete Record
                                    </button>
                                </form>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header bg-light">
                        <h6 class="mb-0"><i class="fe fe-user fe-16 mr-2"></i>Solo Parent Information</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header bg-light">
                        <h6 class="mb-0"><i class="fe fe-alert-triangle fe-16 mr-2"></i>Violence Against Women (VAW) Case</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
