...
<li class="breadcrumb-item"><a href="{{ route('admin.gad.show', $gad->id) }}">{{ $gad->resident->full_name }}</a></li>
<li class="breadcrumb-item active" aria-current="page">Edit</li>
@endsection

@section('page-title', 'Edit GAD Record')
@section('page-subtitle', 'Update Gender & Development record for ' . $gad->resident->full_name)
        ...
        <div class="card shadow mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-0"><i class="fe fe-edit fe-16 mr-2 text-primary"></i>Edit GAD Record</h4>
                        <p class="text-muted mb-0">{{ $gad->resident->full_name }} - {{ $gad->resident->barangay_id }}</p>
                    </div>
                    <div>
                        <a href="{{ route('admin.gad.show', $gad->id) }}" class="btn btn-outline-secondary">
                            <i class="fe fe-arrow-left fe-16 mr-2"></i>Back to Details
                        </a>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.gad.update', $gad->id) }}" method="POST" id="gadEditForm">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-light">
                            <h6 class="mb-0"><i class="fe fe-user fe-16 mr-2"></i>Basic Information</h6>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-light">
                            <h6 class="mb-0"><i class="fe fe-activity fe-16 mr-2"></i>Program Enrollment</h6>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-12">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-light d-flex align-items-center">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label font-weight-bold mb-0" for="is_pregnant_toggle">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-light d-flex align-items-center">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label font-weight-bold mb-0" for="is_solo_parent_toggle">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-light d-flex align-items-center">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label font-weight-bold mb-0" for="is_vaw_case_toggle">
                                    <i class="fe fe-alert-triangle fe-16 mr-2"></i>VAW Case Information
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-light">
                            <h6 class="mb-0"><i class="fe fe-file-text fe-16 mr-2"></i>Additional Notes</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-end mt-4 mb-4">
                        <a href="{{ route('admin.gad.show', $gad->id) }}" class="btn btn-outline-secondary mr-2">
                            <i class="fe fe-x fe-16 mr-2"></i>Cancel
                        </a>
                        <button type="submit" class="btn btn-primary" id="submitButton">
                            <i class="fe fe-save fe-16 mr-2"></i>Update GAD Record
                        </button>
                    </div>
                </form>
            </div>
