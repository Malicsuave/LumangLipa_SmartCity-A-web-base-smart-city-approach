<?php $__env->startSection('title', 'Request Document'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    checkResidentBtn.addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("documents.check-resident")); ?>', {
            method: 'POST',
            headers: {
    ...
    sendOtpBtn.addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("documents.send-otp")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    verifyOtpBtn.addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("documents.verify-otp")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php echo $__env->make('layouts.public.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lumanglipa/resources/views/public/forms/document-request.blade.php ENDPATH**/ ?>