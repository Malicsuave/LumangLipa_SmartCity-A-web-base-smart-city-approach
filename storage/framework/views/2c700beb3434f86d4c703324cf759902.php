<?php $__env->startSection('title', 'Barangay Lumanglipa - Official Website'); ?>

<?php $__env->startPush('styles'); ?>
<style>
    /* Hero Section Background */
    .hero-section {
        background-image: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('<?php echo e(asset("images/bglumanglipa.jpeg")); ?>');
...
<section class="hero-section">
    ...
    <div class="container">
        <div class="hero-content">
            ...
            <img src="<?php echo e(asset('/images/logo.png')); ?>" alt="Barangay Lumanglipa Logo" class="mobile-hero-logo" onerror="console.error('Logo failed to load'); this.style.display='none';">
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('public.contact')); ?>" class="hero-btn btn-contact">CONTACT US</a>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="hero-btn btn-login">GO TO DASHBOARD</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="hero-btn btn-login">LOGIN NOW</a>
                <?php endif; ?>
            </div>
            ...
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <a href="<?php echo e(route('public.about')); ?>" class="service-btn">Learn More</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <a href="<?php echo e(route('documents.request')); ?>" class="service-btn">Learn More</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-5" style="background-color: #f8f9fa;">
    <div class="container">
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(route('public.about')); ?>" class="btn btn-primary">View All Announcements</a>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card bg-primary text-white shadow">
                    <div class="card-body text-center p-5">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-light">Go to Dashboard</a>
                        <?php else: ?>
                            <div class="d-flex justify-content-center gap-3">
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-light">Login</a>
                                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light">Register Now</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.public.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lumanglipa/resources/views/public/home.blade.php ENDPATH**/ ?>