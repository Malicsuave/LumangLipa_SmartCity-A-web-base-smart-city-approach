...
<head>
    ...
    <title>Certificate of Low Income - <?php echo e($fullName); ?></title>
    <?php
                    ...
                    <td class="cert-left" style="vertical-align: top; position: relative; padding-bottom: 0;">                        <div>
                            ...
                            <div class="officials-list">
                                ...
                                <?php for($i = 1; $i <= 7; $i++): ?>
                                    ...
                                    <?php if($committee): ?>
                                        <div class="official-committee"><?php echo e($committee); ?></div>
                                    <?php endif; ?>
                                    <br>
                                <?php endfor; ?>
                                ...
                                <?php if($sk_committee): ?>
                                    <div class="official-committee"><?php echo e($sk_committee); ?></div>
                                <?php endif; ?>
                                <br>
                                ...
                                <td colspan="2" style="padding-top:0;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <div style="text-indent: 40px;">
                                            <br>
                                            <span class="cert-bold">THIS IS TO CERTIFY that</span>                                            <span class="cert-fill"><?php echo e(strtoupper($fullName)); ?></span>
                                            of legal age, is a resident of Purok
                                            <span class="cert-fill-short"><?php echo e($purok ?? 'N/A'); ?></span>
                                            ...
                                            <span class="cert-fill-short"><?php echo e(strtoupper($income ?? 'N/A')); ?></span>
                                            on his nowadays as
                                            <span class="cert-fill-short"><?php echo e($occupation ?? 'N/A'); ?></span>.
                                        </div>
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            ...
                                            <span class="cert-fill"><?php echo e(\Carbon\Carbon::parse($dateIssued)->format('F')); ?></span>
                                            <span class="cert-fill-year"><?php echo e(\Carbon\Carbon::parse($dateIssued)->format('Y')); ?></span>
...
<?php /**PATH /var/www/html/lumanglipa/resources/views/documents/templates/certificate-of-low-income-original.blade.php ENDPATH**/ ?>