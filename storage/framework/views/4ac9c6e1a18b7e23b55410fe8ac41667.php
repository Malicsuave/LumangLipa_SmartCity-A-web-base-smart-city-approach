...
<link rel="stylesheet" href="<?php echo e(asset('css/admin/modern-dashboard.css')); ?>">
<?php $__env->stopPush(); ?>
    ...
    <div class="col-12 mb-4">
        <div class="welcome-widget-outlined p-4 d-flex align-items-center">
            <div>
                ...
                <p class="card-text mb-0">Manage residents, requests, and barangay services efficiently. Have a great day, <strong><?php echo e(Auth::user()->name); ?></strong>!</p>
            </div>
        </div>
    </div>
        ...
        <div class="document-metric-card">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($metrics['total_residents']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="document-metric-card">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($metrics['households_count']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="document-metric-card">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($metrics['family_members_count']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="document-metric-card">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($metrics['total_population']); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    try {
        ...
        var rtChart = new Chart(rtCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($metrics['non_migrant_count']); ?>, <?php echo e($metrics['migrant_count']); ?>, <?php echo e($metrics['transient_count']); ?>],
        ...
        var gdChart = new Chart(gdCtx, {
            ...
            data: {
                labels: ['Male', 'Female'],
                datasets: [{
                    data: [<?php echo e($metrics['male_residents']); ?>, <?php echo e($metrics['female_residents']); ?>],
        ...
        var agChart = new Chart(agCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [<?php echo e($metrics['children']); ?>, <?php echo e($metrics['adults']); ?>, <?php echo e($metrics['senior_citizens']); ?>],
        ...
        var mrChart = new Chart(mrCtx, {
            type: 'line',
            data: {
                labels: <?php echo json_encode($chartData['monthly_registrations']['labels']); ?>,
                datasets: [{
                    label: 'New Registrations',
                    data: <?php echo json_encode($chartData['monthly_registrations']['data']); ?>,
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lumanglipa/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>