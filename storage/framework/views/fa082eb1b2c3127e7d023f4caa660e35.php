        ...
        <div class="card document-metric-card shadow">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($stats['total']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card document-metric-card shadow">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($stats['pending']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card document-metric-card shadow">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($stats['approved']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card document-metric-card shadow">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($stats['claimed']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card document-metric-card shadow">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <span class="h3 mb-0"><?php echo e($stats['rejected']); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card shadow-lg border-0 admin-card-shadow">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.documents')); ?>" method="GET" id="filterForm">
                    <!-- Search and Filter Toggle -->
                    <div class="row mb-4">
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" class="form-control" name="search" placeholder="Search by resident name, document type, purpose..." value="<?php echo e(request('search')); ?>">
                        ...
                        <div class="col-md-4">
                            <?php if(request()->hasAny(['search', 'status', 'document_type', 'date_from', 'date_to'])): ?>
                                <a href="<?php echo e(route('admin.documents')); ?>" class="btn btn-outline-secondary">
                    ...
                    <div class="collapse <?php echo e(request()->hasAny(['status', 'document_type', 'date_from', 'date_to']) ? 'show' : ''); ?>" id="filterSection">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="document_type" class="form-control form-control-sm">
                                            ...
                                            <option value="Barangay Clearance" <?php echo e(request('document_type') == 'Barangay Clearance' ? 'selected' : ''); ?>>Barangay Clearance</option>
                                            <option value="Certificate of Residency" <?php echo e(request('document_type') == 'Certificate of Residency' ? 'selected' : ''); ?>>Certificate of Residency</option>
                                            <option value="Certificate of Indigency" <?php echo e(request('document_type') == 'Certificate of Indigency' ? 'selected' : ''); ?>>Certificate of Indigency</option>
                                            <option value="Certificate of Low Income" <?php echo e(request('document_type') == 'Certificate of Low Income' ? 'selected' : ''); ?>>Certificate of Low Income</option>
                                            <option value="Business Permit" <?php echo e(request('document_type') == 'Business Permit' ? 'selected' : ''); ?>>Business Permit</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 mb-3">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="badge badge-info ml-2"><?php echo e($documentRequests->total()); ?> results found</span>
                                </div>
                            ...
                            <div class="mt-2">
                                ...
                                <?php endif; ?>
                                <?php if(request('document_type')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['document_type' => null])); ?>" class="badge badge-success mr-1 text-decoration-none">
                                        Type: <?php echo e(request('document_type')); ?> <i class="fe fe-x"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if(request('date_from')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['date_from' => null])); ?>" class="badge badge-warning mr-1 text-decoration-none">
                                        From: <?php echo e(request('date_from')); ?> <i class="fe fe-x"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if(request('date_to')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['date_to' => null])); ?>" class="badge badge-info mr-1 text-decoration-none">
                                        To: <?php echo e(request('date_to')); ?> <i class="fe fe-x"></i>
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="resultsTable" class="table table-borderless table-striped table-hover">
                        <thead>
                            <tr>
                                <th>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'id', 'direction' => request('sort') == 'id' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                                        ID
                                ...
                                <th>Resident</th>
                                <th>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'document_type', 'direction' => request('sort') == 'document_type' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                                        Document Type
                                        <?php if(request('sort') == 'document_type'): ?>
                                            <i class="fe fe-chevron-<?php echo e(request('direction') == 'asc' ? 'up' : 'down'); ?> ml-1"></i>
                                        <?php else: ?>
                                            <i class="fe fe-chevrons-up-down ml-1 text-muted" style="font-size: 12px;"></i>
                                        <?php endif; ?>
                                ...
                                <th>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'requested_at', 'direction' => request('sort') == 'requested_at' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                                        Date Requested
                                        <?php if(request('sort') == 'requested_at'): ?>
                                            <i class="fe fe-chevron-<?php echo e(request('direction') == 'asc' ? 'up' : 'down'); ?> ml-1"></i>
                                        <?php else: ?>
                                            <i class="fe fe-chevrons-up-down ml-1 text-muted" style="font-size: 12px;"></i>
                                        <?php endif; ?>
                                ...
                                <th>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'status', 'direction' => request('sort') == 'status' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                                        Status
                        ...
                        <tbody>
                            <?php $__currentLoopData = $documentRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($request->resident ? $request->resident->first_name . ' ' . ($request->resident->middle_name ? $request->resident->middle_name . ' ' : '') . $request->resident->last_name : 'Unknown'); ?></td>
                                    <td><?php echo e($request->document_type); ?></td>
                                    <td><?php echo e(date('M d, Y', strtotime($request->requested_at))); ?></td>
                                    <td>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div class="text-muted small">
                        Showing <?php echo e($documentRequests->firstItem() ?? 0); ?> to <?php echo e($documentRequests->lastItem() ?? 0); ?> of <?php echo e($documentRequests->total()); ?> document requests
                    </div>
                    <nav aria-label="Table Paging" class="mb-0">
                        <ul class="pagination justify-content-end mb-0">
                            <?php if($documentRequests->onFirstPage()): ?>
                            ...
                            <?php else: ?>
                                <li class="page-item"><a class="page-link" href="<?php echo e($documentRequests->previousPageUrl()); ?>"><i class="fe fe-arrow-left"></i> Previous</a></li>
                            <?php endif; ?>
                            <?php for($i = 1; $i <= $documentRequests->lastPage(); $i++): ?>
                                <li class="page-item <?php echo e($i == $documentRequests->currentPage() ? 'active' : ''); ?>">
                                    <a class="page-link" href="<?php echo e($documentRequests->url($i)); ?>"><?php echo e($i); ?></a>
                                </li>
                            <?php endfor; ?>
                            <?php if($documentRequests->hasMorePages()): ?>
                                <li class="page-item"><a class="page-link" href="<?php echo e($documentRequests->nextPageUrl()); ?>">Next <i class="fe fe-arrow-right"></i></a></li>
                            <?php else: ?>
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">
                        <?php if(request()->hasAny(['search', 'status', 'document_type', 'date_from', 'date_to'])): ?>
                            No document requests match your search criteria. <a href="<?php echo e(route('admin.documents')); ?>">Clear all filters</a>
                        <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.clearAllFilters = function() {
        ...
        window.location.href = "<?php echo e(route('admin.documents')); ?>";
    };
});
</script>
<script>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lumanglipa/resources/views/admin/documents.blade.php ENDPATH**/ ?>