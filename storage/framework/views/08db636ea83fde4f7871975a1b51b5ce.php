...
<head>
    ...
    <title>Certificate of Indigency - <?php echo e($fullName); ?></title>
    <?php
    ...
    <div class="container">        <?php if($isPrintMode): ?>
                                        ...
                                        <td colspan="2" style="padding-top:0;">
                                            <div class="certificate-body" style="margin-top:0;">
                                                ...
                                                <div style="text-indent: 40px;">
                                                    ...
                                                    <span class="cert-fill-short"><?php echo e($purpose); ?></span>
                                                ...
                                                <div style="text-indent: 40px; margin-top: 18px;">
                                                    ...
                                                    <span class="cert-fill-year"><?php echo e(\Carbon\Carbon::parse($dateIssued)->format('Y')); ?></span> at Barangay Lumanglipa, Mataas na Kahoy, Batangas for whatever legal purposes it may serve.
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php /**PATH /var/www/html/lumanglipa/resources/views/documents/templates/certificate-of-indigency-original.blade.php ENDPATH**/ ?>