<?php $__env->startSection('title', 'Health Services Management'); ?>
    ...
    <div class="col-md-12">
        <div class="card shadow-lg border-0 admin-card-shadow">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="<?php echo e(route('admin.health-services.index')); ?>" id="filterForm">
                <div class="row mb-4">
                    <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <?php if(request()->hasAny(['search', 'status', 'service_type', 'date_from', 'date_to'])): ?>
                                <a href="<?php echo e(route('admin.health-services.index')); ?>" class="btn btn-outline-secondary">
                    ...
                    <div class="collapse <?php echo e(request()->hasAny(['status', 'service_type', 'date_from', 'date_to']) ? 'show' : ''); ?>" id="filterSection">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="service_type" class="form-control form-control-sm">
                                            ...
                                            <option value="medical_consultation" <?php echo e(request('service_type') == 'medical_consultation' ? 'selected' : ''); ?>>Medical Consultation</option>
                                            <option value="health_certificate" <?php echo e(request('service_type') == 'health_certificate' ? 'selected' : ''); ?>>Health Certificate</option>
                                            <option value="immunization" <?php echo e(request('service_type') == 'immunization' ? 'selected' : ''); ?>>Immunization</option>
                                            <option value="prenatal_care" <?php echo e(request('service_type') == 'prenatal_care' ? 'selected' : ''); ?>>Prenatal Care</option>
                                            <option value="family_planning" <?php echo e(request('service_type') == 'family_planning' ? 'selected' : ''); ?>>Family Planning</option>
                                            <option value="nutrition_counseling" <?php echo e(request('service_type') == 'nutrition_counseling' ? 'selected' : ''); ?>>Nutrition Counseling</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 mb-3">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span class="badge badge-info ml-2"><?php echo e($healthRequests->total()); ?> results found</span>
                            </div>
                        ...
                        <div class="mt-2">
                            ...
                            <?php if(request('service_type')): ?>
                                <a href="<?php echo e(request()->fullUrlWithQuery(['service_type' => null])); ?>" class="badge badge-success mr-1 text-decoration-none">
                                    Service: <?php echo e(ucwords(str_replace('_', ' ', request('service_type')))); ?> <i class="fe fe-x"></i>
                                </a>
                            <?php endif; ?>
                    ...
                    <?php if($healthRequests->count() > 0): ?>
                        ...
                        <table class="table table-borderless table-striped table-hover">
                            <thead>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $healthRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="badge <?php echo e($statusClass); ?> text-capitalize"><?php echo e($request->status); ?></span>
                                            </td>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div class="text-muted small">
                                Showing <?php echo e($healthRequests->firstItem() ?? 0); ?> to <?php echo e($healthRequests->lastItem() ?? 0); ?> of <?php echo e($healthRequests->total()); ?> health service requests
                            </div>
                            <nav aria-label="Table Paging" class="mb-0">
                                <ul class="pagination justify-content-end mb-0">
                                    <?php if($healthRequests->onFirstPage()): ?>
                                    ...
                                    <?php else: ?>
                                        <li class="page-item"><a class="page-link" href="<?php echo e($healthRequests->previousPageUrl()); ?>"><i class="fe fe-arrow-left"></i> Previous</a></li>
                                    <?php endif; ?>
                                    <?php for($i = 1; $i <= $healthRequests->lastPage(); $i++): ?>
                                        <li class="page-item <?php echo e($i == $healthRequests->currentPage() ? 'active' : ''); ?>">
                                            <a class="page-link" href="<?php echo e($healthRequests->url($i)); ?>"><?php echo e($i); ?></a>
                                        </li>
                                    <?php endfor; ?>
                                    <?php if($healthRequests->hasMorePages()): ?>
                                        <li class="page-item"><a class="page-link" href="<?php echo e($healthRequests->nextPageUrl()); ?>">Next <i class="fe fe-arrow-right"></i></a></li>
                                    <?php else: ?>
                ...
                <div class="text-center py-5" id="healthNoResults">
                    ...
                    <p class="text-muted">
                        <?php if(request()->hasAny(['search', 'status', 'service_type', 'date_from', 'date_to'])): ?>
                            No health service requests match your search criteria. <a href="<?php echo e(route('admin.health-services.index')); ?>">Clear all filters</a>
                        <?php else: ?>
...
function clearAllFilters() {
    ...
    window.location.href = "<?php echo e(route('admin.health-services.index')); ?>";
}
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lumanglipa/resources/views/admin/health-services.blade.php ENDPATH**/ ?>