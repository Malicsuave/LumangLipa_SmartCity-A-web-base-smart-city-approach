<?php $__env->startSection('title', 'Pre-Registration Management'); ?>
...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a href="<?php echo e(route('public.pre-registration.step1')); ?>" class="btn btn-outline-secondary" target="_blank">
    ...
    <div class="col-md-12">
        <div class="card shadow-lg border-0 admin-card-shadow">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="<?php echo e(route('admin.pre-registrations.index')); ?>" id="filterForm">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <?php if(request()->hasAny(['search', 'status', 'type_of_resident', 'age_group', 'gender', 'civil_status', 'education', 'date_from', 'date_to'])): ?>
                                <a href="<?php echo e(route('admin.pre-registrations.index')); ?>" class="btn btn-outline-secondary">
                    ...
                    <div class="collapse <?php echo e(request()->hasAny(['status', 'type_of_resident', 'age_group', 'gender', 'civil_status', 'education', 'date_from', 'date_to']) ? 'show' : ''); ?>" id="filterSection">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="type_of_resident" class="form-control form-control-sm">
                                            ...
                                            <option value="Non-migrant" <?php echo e(request('type_of_resident') == 'Non-migrant' ? 'selected' : ''); ?>>Non-migrant</option>
                                            <option value="Migrant" <?php echo e(request('type_of_resident') == 'Migrant' ? 'selected' : ''); ?>>Migrant</option>
                                            <option value="Transient" <?php echo e(request('type_of_resident') == 'Transient' ? 'selected' : ''); ?>>Transient</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="education" class="form-control form-control-sm">
                                            ...
                                            <option value="Highschool" <?php echo e(request('education') == 'Highschool' ? 'selected' : ''); ?>>Highschool</option>
                                            <option value="College" <?php echo e(request('education') == 'College' ? 'selected' : ''); ?>>College</option>
                                            ...
                                            <option value="not applicable" <?php echo e(request('education') == 'not applicable' ? 'selected' : ''); ?>>Not Applicable</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="badge badge-info ml-2"><?php echo e($preRegistrations->total()); ?> results found</span>
                                </div>
                            ...
                            <div class="mt-2">
                                ...
                                <?php endif; ?>
                                <?php if(request('type_of_resident')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['type_of_resident' => null])); ?>" class="badge badge-success mr-1 text-decoration-none">
                                        Type: <?php echo e(request('type_of_resident')); ?> <i class="fe fe-x"></i>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if(request('civil_status')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['civil_status' => null])); ?>" class="badge badge-secondary mr-1 text-decoration-none">
                                        Civil Status: <?php echo e(request('civil_status')); ?> <i class="fe fe-x"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if(request('education')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['education' => null])); ?>" class="badge badge-light mr-1 text-decoration-none">
                                        Education: <?php echo e(request('education')); ?> <i class="fe fe-x"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if(request('date_from')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['date_from' => null])); ?>" class="badge badge-danger mr-1 text-decoration-none">
                                        From: <?php echo e(request('date_from')); ?> <i class="fe fe-x"></i>
                                    </a>
                                <?php endif; ?>
                                <?php if(request('date_to')): ?>
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['date_to' => null])); ?>" class="badge badge-dark mr-1 text-decoration-none">
                ...
                <?php if($preRegistrations->count() > 0): ?>
                    <div class="table-responsive">
                        <table id="resultsTable" class="table table-borderless table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>
                                        <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'first_name', 'direction' => request('sort') == 'first_name' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" 
                                    ...
                                    <th>
                                        <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'email_address', 'direction' => request('sort') == 'email_address' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" 
                                           class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                                            Email
                                            <?php if(request('sort') == 'email_address'): ?>
                                                <i class="fe fe-chevron-<?php echo e(request('direction') == 'asc' ? 'up' : 'down'); ?> ml-1"></i>
                                            <?php else: ?>
                                                <i class="fe fe-chevrons-up-down ml-1 text-muted" style="font-size: 12px;"></i>
                                            <?php endif; ?>
                                    ...
                                    <th>
                                        <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'age', 'direction' => request('sort') == 'age' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" 
                                           class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                                            Age
                                            <?php if(request('sort') == 'age'): ?>
                                                <i class="fe fe-chevron-<?php echo e(request('direction') == 'asc' ? 'up' : 'down'); ?> ml-1"></i>
                                            <?php else: ?>
                                                <i class="fe fe-chevrons-up-down ml-1 text-muted" style="font-size: 12px;"></i>
                                            <?php endif; ?>
                                    ...
                                    <th>
                                        <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'created_at', 'direction' => request('sort') == 'created_at' && request('direction') == 'asc' ? 'desc' : 'asc'])); ?>" 
                                           class="text-decoration-none d-flex align-items-center" style="color: inherit;">
                                            Submitted
                            ...
                            <tbody>
                                <?php $__currentLoopData = $preRegistrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $dropdownItems = [];
                                        $dropdownItems[] = [
                                            'label' => 'View Details',
                                    ...
                                    <tr>
                                        <td>
                                            <strong><?php echo e($registration->full_name); ?></strong>
                                            <?php if($registration->is_senior_citizen): ?>
                                                <br><small class="badge badge-warning">Senior Citizen</small>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($registration->email_address); ?></td>
                                        <td><?php echo e($registration->contact_number); ?></td>
                                        <td><?php echo e($registration->age); ?></td>
                                        <td class="type-col"><?php echo e($registration->type_of_resident); ?></td>
                                        <td>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div class="text-muted small">
                                Showing <?php echo e($preRegistrations->firstItem() ?? 0); ?> to <?php echo e($preRegistrations->lastItem() ?? 0); ?> of <?php echo e($preRegistrations->total()); ?> pre-registrations
                        </div>
                        <nav aria-label="Table Paging" class="mb-0">
                            <ul class="pagination justify-content-end mb-0">
                                    <?php echo $preRegistrations->appends(request()->query())->links(); ?>
                ...
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">
                        No applications match your search criteria. <a href="<?php echo e(route('admin.pre-registrations.index')); ?>">Clear all filters</a>
                    </p>
                    <a href="<?php echo e(route('public.pre-registration.step1')); ?>" class="btn btn-primary" target="_blank">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/lumanglipa/resources/views/admin/pre-registrations/index.blade.php ENDPATH**/ ?>