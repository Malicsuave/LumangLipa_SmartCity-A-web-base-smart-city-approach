...
<head>
    ...
    <title>Certificate of Residency - <?php echo e($fullName); ?></title>
    <?php
    ...
    <style>
        ...
        @media print {
            ...
            .container {
                ...
                padding: 0.05in !important; /* reduced for equal margins */
                margin: 0 !important;
                background: white !important;
                width: 100% !important;
            ...
            /* Match watermark sizing with Barangay Clearance */
            .cert-right::before {
                        ...
                        <div style="position: absolute; left: 0; right: 0; bottom: 0; padding: 12px 0 10px 0;">
                            ...
                            <?php if(isset($qrCode)): ?>
                                <div style="text-align:center;">
                                    <img src="data:image/png;base64,<?php echo e($qrCode); ?>" alt="QR Code" width="170" height="170" style="display:block; margin:0 auto; border:2px solid #1a4fa3; background:#fff; padding:4px; border-radius:8px;">
                                </div>
                            <?php endif; ?>
                        </div>
                    </td>
                        ...
                        <table style="width:100%; border-collapse:collapse;">
                            <tr>
                                <td colspan="2" style="position:relative; padding-bottom:0;">
                                    <!-- LOGO TOP LEFT -->
                                    <img src="<?php echo e('file://' . public_path('images/logo.png')); ?>" alt="Barangay Logo" class="logo" style="position:absolute; top:0; left:8px; margin-top:-20px; margin-left:0;">
                                    <div style="text-align:center;">
                                ...
                                <td colspan="2" style="padding-top:0;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <div style="text-indent: 40px;">
                                            ...
                                            of legal age and is a bona fide resident of Purok
                                            <span class="cert-fill-purok"><?php echo e(strtoupper($purok ?? 'N/A')); ?></span>
                                            Barangay Lumanglipa, Mataasnakahoy, Batangas. She/He is known to me to be a person of good moral character, peaceful and law-abiding citizen.
                                        </div>
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            This further certifies that she/he has never been a member nor connected with any subversive organization that seeks to overthrow our government.
                                        </div>
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            Issued this
                                            ...
                                            <span class="cert-fill-year"><?php echo e(\Carbon\Carbon::parse($dateIssued)->format('Y')); ?></span> at Barangay Lumanglipa, Mataasnakahoy, Batangas, for whatever purposes it may legally serve.
                                        </div>
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            Please extend all the possible effort you can give to the bearer of this letter.<br>
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align:center; padding-bottom:10px;">
                                                ...
                                                <br>
                                                    ...
                                                    <span class="cert-bold"><?php echo e($officials->captain_name); ?></span><br>
...
<?php /**PATH /var/www/html/lumanglipa/resources/views/documents/templates/certificate-of-residency-fixed.blade.php ENDPATH**/ ?>