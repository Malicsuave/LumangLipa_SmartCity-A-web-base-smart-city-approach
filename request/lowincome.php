...
<head>
    ...
    <title>Certificate of Low Income Request</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="form-header">
            <h2>Certificate of Low Income Request</h2>
                                ...
                                <td colspan="2" style="padding-top:0;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <div style="text-indent: 40px;">
                                            ...
                                            <span class="cert-fill-short" id="certPurok">__________</span>
                                        ...
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            ...
                                            <span class="cert-fill-short" id="certIncome">__________</span>
                                            on his nowadays as
                                            <span class="cert-fill-short" id="certOccupation">__________</span>.
                                        </div>
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            This certification is issued this
                                            <span class="cert-fill-day" id="certDay">_____</span> day of
                                            <span class="cert-fill" id="certMonth">_____________________</span>
                                            <span class="cert-fill-year" id="certYear">______</span>
    ...
    <script>
        function generateCertificate() {
            ...
            if (!fullName || !purok || !monthlyIncome || !occupation || !dateIssued) {
            ...
            document.getElementById('certIncome').textContent = monthlyIncome;
            document.getElementById('certOccupation').textContent = occupation;
