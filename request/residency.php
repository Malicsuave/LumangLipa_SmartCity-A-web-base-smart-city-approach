...
<body>
    <div class="container">
        <div class="form-header">
            <h2>Certificate of Residency Request</h2>
                                ...
                                <td colspan="2" style="padding-top:0;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <div style="text-indent: 40px;">
                                            ...
                                            <span class="cert-fill-purok" id="certPurok">__________</span>
                                        ...
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            ...
                                            <span class="cert-fill-year" id="certYear">______</span> at Barangay Lumanglipa, Mataasnakahoy, Batangas, for whatever purposes it may legally serve.
                                        </div>
                                        <div style="text-indent: 40px; margin-top: 18px;">
    ...
    <script>
        function generateCertificate() {
            ...
            document.getElementById('certPurok').textContent = purok;
