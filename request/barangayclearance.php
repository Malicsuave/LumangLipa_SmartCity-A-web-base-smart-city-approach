...
<body>
    <div class="container">
        <div class="form-header">
            ...
            <p>Fill out the form below to generate the clearance</p>
        </div>
        <form id="clearanceForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="purpose" name="purpose" placeholder="e.g., Employment, Scholarship, etc." required>
            </div>
            <div class="form-group">
                <label for="issuedBy">Issued By (optional):</label>
                <input type="text" id="issuedBy" name="issuedBy" placeholder="Name of person who issued">
            </div>
            <div class="button-group">
                <button type="button" class="btn" onclick="generateClearance()">Generate Clearance</button>
                <button type="button" class="btn btn-secondary" onclick="printClearance()">Print Clearance</button>
                ...
                <tr>
                    ...
                    <td class="cert-right" style="vertical-align: top; position: relative; padding-bottom: 0;">
                        <table style="width:100%; border-collapse:collapse;">
                            <tr>
                                <td colspan="2" style="position:relative; padding-bottom:0;">
                                    <!-- LOGO TOP LEFT -->
                                    <img src="logo.png" alt="Barangay Logo" style="width:130px; position:absolute; top:0; left:0; margin-top:-20px; margin-left:-45px;">
                                ...
                                <td colspan="2" style="padding-top:0;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            ...
                                            <span class="cert-fill-short" id="certPurpose">_________________________</span>
                                            this
                                            <span class="cert-fill-day" id="certDay">_____</span> day of
                                            <span class="cert-fill-month" id="certMonth">_____________________</span>,
                                            <span class="cert-fill-year" id="certYear">______</span> at Barangay Lumanglipa, Mataasnakahoy, Batangas for any legal purposes it may serve.
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <div style="margin-top: 10px; font-size: 16px;">
                            Issued by: <span class="signature-line" style="width:220px;" id="certIssuedBy"></span>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <script>
        function generateClearance() {
            ...
            if (!fullName || !dateIssued || !purpose) {
            ...
            document.getElementById('certPurpose').textContent = purpose;
            ...
            document.getElementById('certIssuedBy').textContent = issuedBy;
        ...
        function printClearance() {
            ...
            if (certificate.style.display === 'none') {
                alert('Please generate the clearance first.');
                return;
            }
            window.print();
        }
