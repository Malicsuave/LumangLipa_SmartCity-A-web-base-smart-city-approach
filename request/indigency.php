...
<body>
    <div class="container">
        <div class="form-header">
            <h2>Certificate of Indigency Request</h2>
        ...
        <form id="indigencyForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="purpose" name="purpose" placeholder="e.g., Medical assistance, Educational purposes" required>
            </div>
            <div class="form-group">
                                ...
                                <td colspan="2" style="padding-top:0;">
                                    <div class="certificate-body" style="margin-top:0;">
                                        ...
                                        <br>
                                            ...
                                            of Barangay Lumanglipa, Mataas na Kahoy, Batangas, belongs to <span class="cert-bold cert-italic">indigent</span> family. The said person is seeking
                                            <span class="cert-fill" id="certPurpose">_________________________</span>
                                        ...
                                        <div style="text-indent: 40px; margin-top: 18px;">
                                            ...
                                            <span class="cert-fill-year" id="certYear">______</span> at Barangay Lumanglipa, Mataas na Kahoy, Batangas for whatever legal purposes it may serve.
                                        </div>
                                    </div>
                                </td>
                            </tr>
